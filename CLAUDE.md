...
- **PixiJS v8 peer dep.** The framework pins `pixi.js@8.21.0`, `@pixi/sound@^6`, and `gsap@^3.13` as peer deps. Plugins/adapters should follow the same peer-dep pattern, not bundle Pixi.
