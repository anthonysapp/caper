import { ActionDetail, Button, FlexContainer, IFocusable, Input, Logger, defineScene } from '@caper/core';
...
export default class FirebasePluginScene extends BaseScene {
  protected readonly title = 'Firebase Plugin';
  protected readonly subtitle = 'Demonstrates Firebase Plugin functionality';
